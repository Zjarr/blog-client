...
import { BORDER_RADIUS_FULL, BORDER_RADIUS_NORMAL, COLOR_BLACK, COLOR_GRAY_LIGHT, COLOR_WHITE, TEXT_NORMAL, TEXT_SMALL } from '../../lib/values';
...
const DEFAULT_CONTAINER_BORDER_RADIUS = BORDER_RADIUS_NORMAL;
