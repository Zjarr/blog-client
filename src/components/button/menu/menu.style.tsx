...
import { COLOR_BLACK, COLOR_BLACK_0, COLOR_PURPLE, COLOR_WHITE, TEXT_EXTRA_SMALL, TEXT_NORMAL } from '../../../utils/values';
...
const CIRCLE_CONTAINER_TEXT_SIZE = TEXT_EXTRA_SMALL;
